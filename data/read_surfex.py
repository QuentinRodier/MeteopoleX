...
def donnees_surfex_batch(start_day, end_day, params_list,
    ...
    # --- Filtrage temporel ---
    #start_dt = dt.datetime(start_day.year, start_day.month, start_day.day)
    #end_dt   = dt.datetime(end_day.year,   end_day.month,   end_day.day,
    #                       23, 59, 59)  # inclure toute la dernière journée
